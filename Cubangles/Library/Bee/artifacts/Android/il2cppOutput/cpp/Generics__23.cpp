...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m128D4635CFF6CA620CA2001F1F418FF84E0E2574(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 55));
		return (RuntimeObject*)L_0;
	}
}
...
{
	{
		...
		L_0 = Dictionary_2_get_Values_mD370D8717BBDC553FC926F659B82E3BA8F885D3D(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 56));
		return (RuntimeObject*)L_0;
	}
}
...
IL_0035:
	{
		...
		V_1 = L_10;
		int32_t L_11 = V_1;
		Dictionary_2_Resize_m8E9C5807A9F45205E0ECC9BAD37DCE1733F12691(__this, L_11, (bool)0, il2cpp_rgctx_method(method->klass->rgctx_data, 51));
		int32_t L_12 = V_1;
		return L_12;
	}
}
